...
# install mrtg
wget -O /etc/snmp/snmpd.conf "https://raw.githubusercontent.com/Chairiel29/install/master/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://raw.githubusercontent.com/Chairiel29/install/master/mrtg-mem.sh"
...
echo ""  | tee -a log-install.txt
echo "Script by Chairiel"  | tee -a log-install.txt
